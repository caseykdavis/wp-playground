<?php
/**
 * wp-playground functions and definitions
 *
...
if (! function_exists('wp_playground_setup')) :
    /**
    ...
    */
    function wp_playground_setup()
    {
        /*
        * Make theme available for translation.
        * Translations can be filed in the /languages/ directory.
        * If you're building a theme based on wp-playground, use a find and replace
        * to change 'wp-playground' to the name of your theme in all the template files.
        */
        load_theme_textdomain('wp-playground', get_template_directory() . '/languages');
        ...
        */
        ...
        register_nav_menus(array(
            'menu-1' => esc_html__('Primary', 'wp-playground'),
        ));
        ...
        */
        ...
        add_theme_support('custom-background', apply_filters('wp_playground_custom_background_args', array(
...
add_action('after_setup_theme', 'wp_playground_setup');
 ...
 */
function wp_playground_scripts()
{
    wp_enqueue_style('wp-playground-style', get_stylesheet_uri());

    wp_enqueue_script('wp-playground-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true);

    wp_enqueue_script('wp-playground-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true);

    if (is_singular() && comments_open() && get_option('thread_comments')) {
        wp_enqueue_script('comment-reply');
    }
}
add_action('wp_enqueue_scripts', 'wp_playground_scripts');
 ...
 */
function wp_playground_content_width()
{
    // This variable is intended to be overruled from themes.
    // Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
    // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
    $GLOBALS['content_width'] = apply_filters('wp_playground_content_width', 640);
}
add_action('after_setup_theme', 'wp_playground_content_width', 0);
 ...
 */
function wp_playground_widgets_init()
{
    register_sidebar(array(
        'name'          => esc_html__('Sidebar', 'wp-playground'),
        'id'            => 'sidebar-1',
        'description'   => esc_html__('Add widgets here.', 'wp-playground'),
...
add_action('widgets_init', 'wp_playground_widgets_init');
